...
** link:session_03/lab_06/lab_06.html[Lab 5 - Verifying a Contract with Pact JVM]
** link:session_03/lab_05/lab_05.html[Lab 6 - Publishing a Contract to Pact Broker]
...
** link:session_04/lab_11/lab_11.html[Lab 11 - Push Microservices to Cloud Foundry]
